...
/** Data transfer object for {@link PlanResult}. */
public class PlanResultDto implements DataTransferObject {
  @JsonProperty
  @Positive private int parallelism;

  public PlanResultDto() {}

  public PlanResultDto(int parallelism) {
